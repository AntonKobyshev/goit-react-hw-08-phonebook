...
export const BackgroundItem = styled.span`
  ...
  &:nth-of-type(31) {
    ...
    box-shadow: -70vmin 0 9.663757707047026vmin currentColor;
  }
  &:nth-of-type(32) {
    color: #3c8677;
    top: 6%;
    ...
    box-shadow: 70vmin 0 8.925464636808474vmin currentColor;
  }
  &:nth-of-type(33) {
    color: #2f2d2d;
    top: 6%;
    ...
    box-shadow: -70vmin 0 9.368942272067962vmin currentColor;
  }
  &:nth-of-type(34) {
    color: #28432e;
    top: 36%;
    ...
    box-shadow: 70vmin 0 8.97920860229468vmin currentColor;
  }
  &:nth-of-type(35) {
    color: #28432e;
    top: 82%;
    ...
    box-shadow: 70vmin 0 8.991678990230946vmin currentColor;
  }
  &:nth-of-type(36) {
    color: #3c8677;
    top: 78%;
    ...
    box-shadow: 70vmin 0 9.445050062629015vmin currentColor;
  }
  &:nth-of-type(37) {
    color: #28432e;
    top: 20%;
    ...
    box-shadow: -70vmin 0 9.471877895766667vmin currentColor;
  }
  &:nth-of-type(38) {
    color: #28432e;
    top: 24%;
    ...
    box-shadow: -70vmin 0 9.186523017329735vmin currentColor;
  }
  &:nth-of-type(39) {
    color: #3c8677;
    top: 76%;
    ...
    box-shadow: 70vmin 0 9.262320974859405vmin currentColor;
  }
  &:nth-of-type(40) {
    color: #28432e;
    top: 13%;
    ...
    box-shadow: 70vmin 0 8.77553323371274vmin currentColor;
  }
  &:nth-of-type(41) {
    color: #3c8677;
    top: 34%;
    ...
    box-shadow: -70vmin 0 8.860814921416084vmin currentColor;
  }
  &:nth-of-type(42) {
    color: #3c8677;
    top: 88%;
    ...
    box-shadow: 70vmin 0 9.583777346393564vmin currentColor;
  }
  &:nth-of-type(43) {
    color: #3c8677;
    top: 42%;
    ...
    box-shadow: -70vmin 0 9.167807974334147vmin currentColor;
  }
  &:nth-of-type(44) {
    color: #2f2d2d;
    top: 14%;
    ...
    box-shadow: -70vmin 0 9.382999602061755vmin currentColor;
  }
  &:nth-of-type(45) {
    color: #2f2d2d;
    top: 56%;
    ...
    box-shadow: 70vmin 0 9.090833567617858vmin currentColor;
  }
  &:nth-of-type(46) {
    color: #28432e;
    top: 32%;

  ...
  return (
    <>
      ...
      <Paragraph>
        ...
        application provides a simple and intuitive interface for searching, adding
        ...
        our Phonebook application will make managing your contacts easy and
        convenient. If you have any questions or issues, feel free to contact
        our support team.
      </Paragraph>
      {!isLoggedIn && (
        <Paragraph>
